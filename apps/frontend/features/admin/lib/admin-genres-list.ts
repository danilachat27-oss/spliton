import type { AdminReleaseGenreListItem } from "@/services/admin/adminReleaseGenres.service";
...
export function applyAdminGenresListFilters(
  items: AdminReleaseGenreListItem[],
  query: AdminGenresListQuery,
): AdminReleaseGenreListItem[] {
  let rows = items;
